...
---@param cargo_metadata table The cargo metadata to parse
---@return string|nil The path to the executable if found
...
---@param config table The initial configuration from launch.json
---@return table The final configuration with executable paths resolved
